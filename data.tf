...
data "aws_ssm_parameter" "ssm_database_subnet_1a" {
  name = var.ssm_database_subnet_1
}

data "aws_ssm_parameter" "ssm_database_subnet_1b" {
  name = var.ssm_database_subnet_2
}

data "aws_ssm_parameter" "ssm_database_subnet_1c" {
  name = var.ssm_database_subnet_3
}
